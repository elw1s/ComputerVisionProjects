...
## coco classes
YOLO_CLASSES = ('bicycle', 'bus', 'car', 'motorbike', 'person')
...
## path root folder
ROOT = '/kaggle/input/traffic-detection-project/train'
...
def xml_transform(root, classes):  
    ...
    os.makedirs(join('/kaggle/working/', 'outputs'), exist_ok=True)
    outpath = join('/kaggle/working/', 'outputs', '%s.xml')
